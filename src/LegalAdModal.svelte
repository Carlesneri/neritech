<script>
    export let openModal, scrollTop;
</script>
...
<section>
    ...
    <p>
        ...
        Electrónico, el Titular expone sus datos identificativos. Correo
        electrónico:
        <a href="mailto:neritechdev@gmail.com">neritechdev@gmail.com</a>
        Sitio Web:
        <a href="/">neritechdev.web.app</a>
    </p>
</section>
<section>
    <h3>Finalidad</h3>
    <p>
        ...
        <a href="/">neritechdev.web.app</a>
        es ofrecer de forma recogida multitud de ofertas de empleo ubicadas
        en España.
    </p>
</section>
<section>
    ...
    <p>
        ...
        <li class="link" on:click={(openModal('legal'), scrollTop())}>
            Aviso Legal
        </li>
        <li class="link" on:click={(openModal('privacity'), scrollTop())}>
            Política de Privacidad
        </li>
        <li class="link" on:click={(openModal('cookies'), scrollTop())}>
            Política de Cookies
        </li>
    </p>
    <p>
        Si no estuviera conforme con todas y cada una de estas cláusulas y
        condiciones absténgase de utilizar este sitio Web. El acceso a este
        sitio Web no supone, en modo alguno, el inicio de una relación
        comercial con el Titular. A través de este sitio Web, el Titular le
        facilita el acceso y la utilización de diversos contenidos que el
        Titular o sus colaboradores han publicadon por medio de Internet. A
        tal efecto, usted está obligado y comprometido a NO utilizar
        cualquiera de los contenidos del sitio Web con fines o efectos
        ilícitos, prohibidos en este Aviso Legal o por la legislación
        vigente, lesivos de los derechos e intereses de terceros, o que de
        cualquier forma puedan dañar, inutilizar, sobrecargar, deteriorar o
        impedir la normal utilización de los contenidos, los equipos
        informáticos o los documentos, archivos y toda clase de contenidos
        almacenados en cualquier equipo informático propios o contratados
        por el Titular, de otros usuarios o de cualquier usuario de
        Internet.
    </p>
    <p>
        <a href="/">neritechdev.web.app</a>
        está altamente comprometido para cumplir con el compromiso de
...
<section>
    ...
    <p>
        ...
        en exclusiva a el Titular, que asume todas las medidas de índole
...
<section>
    ...
    <p>
        ...
        datos personales que recoge el Titular en la página de la Política
        de Privacidad.
    </p>
</section>
<section>
    ...
    <p>
        ...
        ni recomendación para realizar cualquier otra operación, salvo que
...
<section>
    ...
    <p>
        ...
        expreso y por escrito de Titular.
    </p>
</section>
<section>
    ...
    <p>
        ...
        sean interrumpidos o que estén libres de errores, que los defectos
        sean corregidos, o que el servicio o el servidor que lo pone a
        disposición estén libres de virus u otros componentes nocivos sin
        perjuicio de que el Titular realiza todos los esfuerzos en evitar
    ...
    <p>
        ...
        fluido eléctrico o cualquier otro tipo de daño indirecto que te
        pueda ser causado por causas ajenas a el Titular.
    </p>
    <p>
...
<section>
    ...
    <p>
        ...
        puedan derivarse de su uso, las partes acuerdan someterse a los
        Jueces y Tribunales de la provincia de Valencia, con renuncia
...
<section>
    ...
    <p>
        ...
        este sitio Web, puede enviar un mensaje de correo electrónico a la
        dirección
        <a href="mailto:neritechdev@gmail.com">neritechdev@gmail.com</a>.
    </p>
</section>
